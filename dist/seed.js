...
async function main() {
    ...
    // ============================================================
    const ukmData = [
        { nama: 'UKM Debat', tipe: 'UKM', fakultasId: null },
        { nama: 'UKM Robotika', tipe: 'UKM', fakultasId: null },
        { nama: 'UKM Paduan Suara', tipe: 'UKM', fakultasId: null },
    ];
    for (const ukm of ukmData) {
        await prisma.organisasi.create({ data: ukm });
    }
    const ukmfData = [
        { nama: 'UKMF IT Community', tipe: 'UKMF', fakultasId: fti.id },
        { nama: 'UKMF Teknik Sipil Club', tipe: 'UKMF', fakultasId: ftek.id },
    ];
