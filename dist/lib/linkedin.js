...
exports.fetchMemberId = fetchMemberId;
exports.uploadImageAndPost = uploadImageAndPost;
...
async function fetchMemberId(accessToken) {
...
async function initializeImageUpload(accessToken, memberId) {
...
async function uploadImageBytes(uploadUrl, imageBuffer) {
...
async function uploadImageAndPost(params) {
