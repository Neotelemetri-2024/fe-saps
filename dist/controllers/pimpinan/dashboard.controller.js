...
exports.dashboardPimpinanFakultas = exports.dashboardPimpinanDitmawa = void 0;
const prisma_1 = __importDefault(require("../../lib/prisma"));
// Helper bersama untuk Pimpinan Ditmawa dan Pimpinan Fakultas
const buildPimpinanDashboard = async (fakultasId) => {
    ...
    const peringkatProdi = prodiStats.map((p, index) => ({
        ranking: index + 1, programStudi: p.nama, rataRataCapaian: p.rataRataCapaianPersen, kategoriPoin: p.kategoriPoin
    }));
