...
export function logout() {
  ...
  if (isSso && !isLocal) {
    // Di production: redirect ke Keycloak SSO UNAND logout
    ...
    // Di local dev atau akun internal: langsung kembali ke /login agar tidak error 'Invalid redirect uri' di Keycloak
