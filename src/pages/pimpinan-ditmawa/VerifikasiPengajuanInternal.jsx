...
const DUMMY_INTERNAL = [
  { id: 'int-1', namaMahasiswa: 'AUFA ALATA', nim: '2310512011', prodi: 'Teknik Komputer, S1', kegiatan: 'TAC (Training Andalasian Character)', kategori: 'Pelatihan', peran: 'Peserta', tanggal: '12 Feb - 14 Feb 2026', status: 'pending', diajukanPada: 'Selasa, 4 Feb 2026, 15:37' },
  { id: 'int-2', namaMahasiswa: 'BUDI SANTOSO', nim: '2310512012', prodi: 'Sistem Informasi, S1', kegiatan: 'Seminar Kepemimpinan UKM', kategori: 'Seminar', peran: 'Panitia', tanggal: '20 Feb 2026', status: 'pending', diajukanPada: 'Rabu, 5 Feb 2026, 10:00' },
  { id: 'int-3', namaMahasiswa: 'CITRA DEWI', nim: '2310512013', prodi: 'Teknik Elektro, S1', kegiatan: 'Latihan Dasar Organisasi', kategori: 'Organisasi', peran: 'Peserta', tanggal: '1 Mar 2026', status: 'disetujui', diajukanPada: 'Kamis, 6 Feb 2026, 09:15' },
]

function VerifikasiPengajuanInternal() {
  const navigate = useNavigate()
  const [items, setItems] = useState(DUMMY_INTERNAL)
  ...
  const handleBulkConfirm = () => {
    ...
    toast.success(`${selected.size} pengajuan internal disetujui.`)
    setSelected(new Set())
  ...
  return (
    <DashboardLayout role="pimpinan-ditmawa" userName="Dr. Dendi Adi Saputra" userRole="Pimpinan Ditmawa">
      <ConfirmModal
        ...
        message={`Apakah Anda yakin ingin menyetujui ${selected.size} pengajuan internal ini?`}
        confirmText="SETUJUI"
        cancelText="BATAL"
      ...
      <div className="space-y-5">
        <div>
          ...
          <p className="mt-1 text-sm text-[#616161]">
            Pengajuan kegiatan internal yang memerlukan verifikasi pimpinan.
          </p>
        </div>
                    ...
                    <tr key={item.id}
                      ...
                      <td className="px-4 py-3">
                        {pilihanMode ? (
                          ...
                          <button type="button"
                            onClick={() => navigate(`/pimpinan-ditmawa/verifikasi-pengajuan-internal/${item.id}`, { state: { item } })}
