...
const DEFAULT_ITEM = {
  kegiatan: 'TAC (Training Andalasian Character)',
  namaEvent: 'TAC 2026',
  jenis: 'Pelatihan',
  tanggal: '12 Feb - 14 Feb 2026',
  penyelenggara: 'BEM Universitas Andalas',
  deskripsi: 'Training Andalasian Character adalah kegiatan wajib bagi mahasiswa baru Universitas Andalas sebagai pembentukan karakter dan pembekalan nilai-nilai keUniversitasan.',
  capaian: ['Fondasi', 'Penguatan'],
  subCapaian: [
    { label: 'Kepemimpinan', persen: '40%' },
    { label: 'Kerja Tim', persen: '30%' },
  ],
  bukti: null,
  status: 'pending',
}
...
function DetailVerifikasiPengajuanInternal() {
  ...
  const backToList = () => navigate('/pimpinan-ditmawa/verifikasi-pengajuan-internal')
