    ...
    <div className="flex min-h-screen w-full font-poppins overflow-hidden bg-white">
      ...
      <div className="relative hidden min-h-screen w-1/2 flex-col justify-center overflow-hidden bg-brand-gradient lg:flex">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <svg className="absolute -left-[49.6%] -top-[27.8%] aspect-square w-[123.5%]" viewBox="0 0 889 889" fill="none">
          ...
          <svg className="absolute -left-[60.8%] -top-[48.1%] aspect-square w-[173.5%]" viewBox="0 0 1249 1249" fill="none">
          ...
          <svg className="absolute -left-[27.6%] top-[71.6%] aspect-square w-[139.2%]" viewBox="0 0 1002 1010" fill="none">
          ...
          <svg className="absolute -left-[19%] top-[80.4%] aspect-square w-[152.1%]" viewBox="0 0 1095 1095" fill="none">
