    ...
    >
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-base-content/60">Kelola event dan verifikasi kehadiran peserta</p>
        </div>
        ...
        <PanduanCard
          ...
          description="Panduan Penggunaan Website MY UNAND STUDENT CONNECT 2026 untuk UKMF"
        />
      </div>
    </DashboardLayout>
  )
